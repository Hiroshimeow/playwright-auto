...
Read `AGENTS.md`, `LEARNING.md`, and `cdpa.yaml` before acting. Verify behavior independently, including durable restart/resume boundaries, ownership, controls, focused tests, full suite, syntax/compile checks, and runtime evidence required by the handoff.
