...
export const state = {
  ...
  selectedIndependentTabByTask: savedMap(saved.selectedIndependentTabByTask),
  selectedTaskJumpByTask: savedMap(saved.selectedTaskJumpByTask),
  selectedDetail: null,
  ...
  timeline: [],
  timelineCursor: null,
  liveEventsByScope: new Map(),
  liveEventsStatusByScope: new Map(),
  liveEventsErrorByScope: new Map(),
  history: [],
  historyCursor: null,
  runtime: null,
  agents: {workflow: [], independent: []},
  agentsStatus: "idle",
  agentsError: null,
  agentReportsRevision: 0,
...
function persist() {
  localStorage.setItem(STORAGE_KEY, JSON.stringify({
    ...
    selectedIndependentTabByTask: [...state.selectedIndependentTabByTask],
    selectedTaskJumpByTask: [...state.selectedTaskJumpByTask],
